...
var path = rootPath + 'common/images/jquerybubblepopup-theme';   
    ...
    $("img[src$='icon-question-cih.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-H</strong> (Communication Intensive in the Humanities, Arts, and Social Sciences): MIT undergraduates must take two such courses, which provide a foundation in writing and oral communication. <a href="http://web.mit.edu/commreq/cih.html">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
                                        themeName: 	'grey',
                                        themePath: 	'http://ocw.mit.edu/images/jquerybubblepopup-theme',
                                        themeMargins: {
                                                        total: '13px',
                                                        difference: '2px'
                                                      }
    ...
    $("img[src$='icon-question-cihw.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-HW</strong> (Communication Intensive in the Humanities, Arts, and Social Sciences - Writing Focused): A subset of MIT freshmen must take one such course, which focuses on the writing process and rhetoric. <a href="http://web.mit.edu/commreq/faculty%20ci-h.html#CI-HW%20Subjects">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-cim.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-M</strong> (Communication Intensive in the Major): MIT undergraduates must take two such courses, which focus on forms of communication relevant to a given field. <a href="http://web.mit.edu/commreq/cim.html">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-fas.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>Freshman Advising Seminar</strong>: A fall-semester, small group, academic class for freshmen that combines advising and learning. <a href="http://mit.edu/firstyear/fas/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-gir.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>GIR</strong> (General Institute Requirements): MIT undergraduates must take certain courses in science and technology; communication; humanities, arts, and social sciences; laboratory; and physical education. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hlevel.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>H-Level Graduate Credit</strong>: Courses with this designation are approved higher-level graduate subjects required for MIT graduate programs. <a href="http://web.mit.edu/catalog/overv.chap4-gdr.html">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS</strong> (Humanities, Arts, and Social Sciences): MIT undergraduates must take eight such courses. <a href="http://web.mit.edu/hassreq/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass-a.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS-A</strong>: MIT undergraduates must take one course designated as Arts in fulfilling the eight-course requirement in Humanities, Arts, and Social Sciences. <a href="http://web.mit.edu/hassreq/index.html#hasscatdef">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass-h.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS-H</strong>: MIT undergraduates must take one course designated as Humanities in fulfilling the eight-course requirement in Humanities, Arts, and Social Sciences. <a href="http://web.mit.edu/hassreq/index.html#hasscatdef">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass-s.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS-S</strong>: MIT undergraduates must take one course designated as Social Sciences in fulfilling the eight-course requirement in Humanities, Arts, and Social Sciences. <a href="http://web.mit.edu/hassreq/index.html#hasscatdef">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-iap.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>IAP</strong> (Independent Activities Period): MIT runs a special four-week term between MIT\'s Fall and Spring semesters. <a href="http://web.mit.edu/iap/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-lab.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>Lab</strong>: MIT undergraduates must take one such course, which emphasizes experimental problems and introduces students to how research in the discipline is conducted. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html#lr">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-rest.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>REST</strong> (Restricted Electives in Science and Technology): MIT undergraduates must take two such courses, which broaden and deepen students\' understanding of basic science and scientific inquiry. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html#restr">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-urop.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>UROP</strong> (Undergraduate Research Opportunities Program): This program provides MIT undergraduates with the resources to pursue research projects under supervision of MIT faculty. <a href="http://web.mit.edu/urop/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
 ...
 // Match for other version tab tool tip mouseover
    $("img[src$='icon-question-ovt.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: 'OCW courses are "snapshots" of a subject as taught in a particular term by specific faculty. Multiple versions in OCW show how the subject has evolved due to changes in the field, different faculty, and new pedagogy.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
...
// Match for Scholar Version tool tip mouseover
    $("img[src$='icon-question-svt.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: 'OCW Scholar courses are among OCW\'s most complete courses, blending content created expressly for OCW with material from on-campus MIT classes. <a href="http://ocw.mit.edu/courses/ocw-scholar/">Learn more about OCW Scholar</a>. ',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
...
// Match for Archived Version tool tip mouseover
    $("img[src$='icon-question-avt.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        position : 'top',
										tail	 : {align: 'middle'},
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: 'These older versions have been replaced by more recent versions, and are archived in the <a href="http://dspace.mit.edu/">DSpace@MIT Repository</a>. ',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
	...
	$("img[src$='icon-question-edx-open.png']").each(function(){ 
										var tag =$(this);
		                                var innerHtml= 'MITx courses typically have defined start and end dates, interactive exercises, integrated assessment, online forums with course staff interaction, and options for certificates of completion. <a href="https://www.edx.org/school/mitx">Learn more about MITx</a>.';
										setBubblePopupProprties(tag,innerHtml);
	}); 
	
	// Match for MITx BubblePop	edx-archived						 
	$("img[src$='icon-question-edx-archived.png']").each(function(){ 
									    var tag =$(this);
                                        var innerHtml= 'Archived MITx courses allow self-study of some course materials and videos after the course has closed. Some features like online forums and certificates may not be available. <a href="https://www.edx.org/school/mitx">Learn more about MITx</a>.';
                                        setBubblePopupProprties(tag,innerHtml);
	 }); 							
